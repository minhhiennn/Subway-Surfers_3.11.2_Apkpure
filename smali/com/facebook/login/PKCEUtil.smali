...
.method public static final generateCodeChallenge(Ljava/lang/String;Lcom/facebook/login/CodeChallengeMethod;)Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    sget-object p1, Lkotlin/l/d;->f:Ljava/nio/charset/Charset;
...
.method public static final generateCodeVerifier()Ljava/lang/String;
    ...
    sget-object v1, Lkotlin/h/c;->a:Lkotlin/h/c$a;

    check-cast v1, Lkotlin/h/c;

    invoke-static {v0, v1}, Lkotlin/i/g;->a(Lkotlin/i/f;Lkotlin/h/c;)I

    move-result v0

    .line 56
    new-instance v1, Lkotlin/i/c;

    const/16 v2, 0x61

    const/16 v3, 0x7a

    invoke-direct {v1, v2, v3}, Lkotlin/i/c;-><init>(CC)V

    check-cast v1, Ljava/lang/Iterable;

    new-instance v2, Lkotlin/i/c;

    const/16 v3, 0x41

    const/16 v4, 0x5a

    invoke-direct {v2, v3, v4}, Lkotlin/i/c;-><init>(CC)V

    check-cast v2, Ljava/lang/Iterable;

    invoke-static {v1, v2}, Lkotlin/a/j;->a(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {v1, v2}, Lkotlin/a/j;->b(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {v1, v2}, Lkotlin/a/j;->a(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/List;
    ...
    sget-object v5, Lkotlin/h/c;->a:Lkotlin/h/c$a;

    check-cast v5, Lkotlin/h/c;

    invoke-static {v4, v5}, Lkotlin/a/j;->a(Ljava/util/Collection;Lkotlin/h/c;)Ljava/lang/Object;
    ...
    invoke-static/range {v3 .. v11}, Lkotlin/a/j;->a(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/e/a/b;ILjava/lang/Object;)Ljava/lang/String;
...
.method public static final isValidCodeVerifier(Ljava/lang/String;)Z
    ...
    .line 45
    :cond_2
    new-instance p0, Lkotlin/l/f;

    const-string v1, "^[-._~A-Za-z0-9]+$"

    invoke-direct {p0, v1}, Lkotlin/l/f;-><init>(Ljava/lang/String;)V

    .line 46
    invoke-virtual {p0, v0}, Lkotlin/l/f;->a(Ljava/lang/CharSequence;)Z
